...
public class Main {
	public static void main(String[] args) {
		...
		//4.xml에서 만들어진 객체를 가져와서 처리한다. ===> 이건 2.5방식임(객체를 가져오고나서 형변환시켜준다)
		//																	---> 3.x버전 형태로 변경이 됨(처음부터 형변환시켜서 가져오기)
		...
		System.out.println("monitor=>"+monitor2);
		System.out.println("monitor=>"+monitor3);
